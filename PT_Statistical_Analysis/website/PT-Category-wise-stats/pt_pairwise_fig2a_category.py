...
base_dir = input("Enter absolute path to curl-based website access time between category pairs of PTs")
data = {}
os.chdir(base_dir)
...
data.to_csv(f"{path}/fig_2a_categorywise.csv", index=False)
